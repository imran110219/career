...
This is the authoritative inventory of skills that may be used in targeted resumes. Skills are included only when current, relevant, and defensible in an interview. Market-demand terms and development goals belong in `master/skill-gaps.md`, not here.
...
These terms appear in older or broad material but do not yet have enough project-specific evidence to be used by default. Confirm the project, level of ownership, and recency before adding them to a resume.

| Term | Current status | Required confirmation |
| --- | --- | --- |
| Flyway | Needs review | Project and migration ownership; Liquibase is already documented for Open-Care. |
| Node.js / Express | Needs review | Project or employment context, responsibilities, and recency. |
| PHP, Spring Cloud, EJS, Puppeteer, WordPress | Legacy / unrecorded | Confirm substantive hands-on use and whether each remains current. |

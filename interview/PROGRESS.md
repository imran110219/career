...
- Lead Backend P0 readiness: delivery leadership, code review, mentoring, system design, production troubleshooting.
- Senior Backend P0 readiness: Java/Spring/PostgreSQL depth, testing evidence, API design, coding patterns.
- Evidence capture: convert verified project facts into case studies without inventing metrics or ownership.

## Dashboard

| Area | Track | Priority | Status | Evidence level | Next action |
| --- | --- | --- | --- | --- | --- |
...
| Security and Keycloak | All tracks | P0 | Reviewing | Professional evidence | Add threat model and authorization story for a sensitive workflow. |
| CI/CD and observability | Lead Backend, Architect | P1 | Reviewing | Professional evidence | Document Jenkins/GitHub Actions scope and observability gaps. |
| AWS/cloud architecture | Architect | P1 | Not started | None | Create a lab or architecture option before using in interviews as experience. |
| Architecture governance | Architect | P1 | Not started | Learning notes | Draft ADR and governance templates tied to one case study. |
| AI-assisted development | Optional | P1 | Reviewing | None | Define workflow and safeguards; record real evidence only after use. |
| Advanced DevSecOps and LLMOps | Optional | P2 | Not started | None | Keep optional unless a target job description makes it central. |
...
- Reorganized interview preparation into shared, role-specific, project, and optional tracks.
- Consolidated original Java, Spring, PostgreSQL, system design, behavioral, story, and project notes into the new structure.
...
- A verified testing example with framework, scope, CI stage and quality impact.
- A database optimization example with baseline, decision, and result.
- A RabbitMQ workflow example with delivery guarantees, retry/idempotency behavior and personal responsibility.
- One mentoring or code-review story with outcome.
- One architecture decision record tied to Open-Care or another public-safe project.

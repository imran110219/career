...
Senior Java Developer | Java | Spring Boot | PostgreSQL | REST APIs | Microservices
...
- **Security & Platform:** Keycloak, Authentication, Authorization, Kubernetes, Nginx, Data Integrity
- **Delivery:** CI/CD, GitHub Actions, Jenkins, Locust, Agile Development, Requirements Analysis, Deployment, Code Review, Mentoring
